...
ui <- fluidPage(
  ...
  tags$head(
    tags$style(HTML("
      ...
      .btn {
        background-color: #A5C679 !important;
        border-color: #A5C679 !important;
        color: black !important;
        font-weight: bold !important;
        transition: background-color 0.2s ease-in-out, box-shadow 0.2s ease-in-out;
        box-shadow: 2px 2px 5px forestgreen !important;
        margin: 5px;
      }
      .btn:hover {
  ...
  tags$img(src = "https://file.garden/Zy75IlKnFHAuCMr4/nycsign2.png", class = "header-image"),
  
  tags$div(class = "spacer"),
  
  tags$img(src = "https://file.garden/Zy75IlKnFHAuCMr4/evacartoon.png", class = "drawing"),
  tags$img(src = "https://file.garden/Zy75IlKnFHAuCMr4/jaycartoon.png", class = "drawing2"),
